// simple_nios_lab_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module simple_nios_lab_mm_interconnect_0 (
		...
		output wire [10:0] onchip_s1_address,                                     //                                       onchip_s1.address
	...
	wire  [90:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> sysid_control_slave_agent:cp_data
	...
	wire  [90:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> nios_debug_mem_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                      // nios_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [5:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> nios_debug_mem_slave_agent:cp_channel
	...
	wire  [14:0] pll_pll_slave_agent_m0_address;                                             // pll_pll_slave_agent:m0_address -> pll_pll_slave_translator:uav_address
	...
	wire  [91:0] pll_pll_slave_agent_rf_source_data;                                         // pll_pll_slave_agent:rf_source_data -> pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [91:0] pll_pll_slave_agent_rsp_fifo_out_data;                                      // pll_pll_slave_agent_rsp_fifo:out_data -> pll_pll_slave_agent:rf_sink_data
	...
	wire  [90:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> pll_pll_slave_agent:cp_data
	...
	wire  [14:0] onchip_s1_agent_m0_address;                                                 // onchip_s1_agent:m0_address -> onchip_s1_translator:uav_address
	...
	wire  [91:0] onchip_s1_agent_rf_source_data;                                             // onchip_s1_agent:rf_source_data -> onchip_s1_agent_rsp_fifo:in_data
	...
	wire  [91:0] onchip_s1_agent_rsp_fifo_out_data;                                          // onchip_s1_agent_rsp_fifo:out_data -> onchip_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                      // cmd_mux_004:src_valid -> onchip_s1_agent:cp_valid
	wire  [90:0] cmd_mux_004_src_data;                                                       // cmd_mux_004:src_data -> onchip_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                      // onchip_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                    // cmd_mux_004:src_channel -> onchip_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                              // cmd_mux_004:src_startofpacket -> onchip_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                // cmd_mux_004:src_endofpacket -> onchip_s1_agent:cp_endofpacket
	...
	wire  [90:0] sysid_control_slave_agent_rp_data;                                          // sysid_control_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [90:0] nios_debug_mem_slave_agent_rp_data;                                         // nios_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [90:0] pll_pll_slave_agent_rp_data;                                                // pll_pll_slave_agent:rp_data -> router_005:sink_data
	...
	wire         onchip_s1_agent_rp_valid;                                                   // onchip_s1_agent:rp_valid -> router_006:sink_valid
	wire  [90:0] onchip_s1_agent_rp_data;                                                    // onchip_s1_agent:rp_data -> router_006:sink_data
	wire         onchip_s1_agent_rp_ready;                                                   // router_006:sink_ready -> onchip_s1_agent:rp_ready
	wire         onchip_s1_agent_rp_startofpacket;                                           // onchip_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         onchip_s1_agent_rp_endofpacket;                                             // onchip_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [90:0] cmd_demux_src3_data;                                                        // cmd_demux:src3_data -> crosser:in_data
	...
	wire  [90:0] crosser_out_data;                                                           // crosser:out_data -> cmd_mux_003:sink0_data
	...
	wire  [90:0] rsp_demux_003_src0_data;                                                    // rsp_demux_003:src0_data -> crosser_001:in_data
	...
	wire  [90:0] crosser_001_out_data;                                                       // crosser_001:out_data -> rsp_mux:sink3_data
	...
	wire         onchip_s1_agent_rdata_fifo_src_valid;                                       // onchip_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] onchip_s1_agent_rdata_fifo_src_data;                                        // onchip_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         onchip_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_004:in_0_ready -> onchip_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                          // avalon_st_adapter_004:out_0_valid -> onchip_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                           // avalon_st_adapter_004:out_0_data -> onchip_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                          // onchip_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                          // avalon_st_adapter_004:out_0_error -> onchip_s1_agent:rdata_fifo_sink_error
	...
	simple_nios_lab_mm_interconnect_0_router router (
	...
	simple_nios_lab_mm_interconnect_0_router_001 router_001 (
	...
	simple_nios_lab_mm_interconnect_0_router_002 router_002 (
	...
	simple_nios_lab_mm_interconnect_0_router_002 router_003 (
	...
	simple_nios_lab_mm_interconnect_0_router_004 router_004 (
	...
	simple_nios_lab_mm_interconnect_0_router_002 router_005 (
	...
	simple_nios_lab_mm_interconnect_0_router_004 router_006 (
	...
	simple_nios_lab_mm_interconnect_0_router_002 router_007 (
	...
	simple_nios_lab_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk12mhz_clk_clk),                                      //       clk.clk
		.reset               (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_demux_003 rsp_demux_003 (
		.clk                (clk12mhz_clk_clk),                                      //       clk.clk
		.reset              (pll_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pll_c0_clk),                             //       clk.clk
		.reset              (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_c0_clk),                             //       clk.clk
		.reset               (nios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	simple_nios_lab_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	simple_nios_lab_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pll_c0_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (onchip_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (onchip_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (onchip_s1_agent_rdata_fifo_src_ready),   //         .ready
